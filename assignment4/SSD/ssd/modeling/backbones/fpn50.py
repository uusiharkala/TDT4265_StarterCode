...
class FPN50(torch.nn.Module):
    ...
    def __init__(self,
        ...
        super().__init__()
        self.resnet = nn.ModuleList(list(torchvision.models.resnet50(pretrained=True).children())[:-1])
        self.out_channels = output_channels
        self.output_feature_shape = output_feature_sizes
        self.fpn = torchvision.ops.FeaturePyramidNetwork(output_channels, 256)
    ...
    def forward(self, x):
        ...
        out_features = self.fpn(out_features_dict)
